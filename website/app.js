...
function initOSDetection() {
  ...
  const releaseBase = 'https://github.com/GTXPOFFIC-developer/PenBridge/releases/download/v1.4.0/';

  let detectedOS = 'windows';
  let downloadUrl = releaseBase + 'PenBridge-Windows-x64-v1.4.0.exe';
  ...
  if (/iphone|ipad|ipod/.test(ua)) {
    detectedOS = 'ios';
    downloadUrl = releaseBase + 'Dashboard-iOS-v1.4.0.zip';
    ...
    detectedOS = 'android';
    downloadUrl = releaseBase + 'PenBridge-Android-v1.4.0.apk';
    ...
    detectedOS = 'macos';
    downloadUrl = releaseBase + 'DashboardHost-macOS-v1.4.0.zip';
    ...
    detectedOS = 'linux';
    downloadUrl = releaseBase + 'DashboardHost-Linux-v1.4.0.tar.gz';
