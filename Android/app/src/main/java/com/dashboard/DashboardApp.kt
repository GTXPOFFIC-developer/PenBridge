...
import com.dashboard.core.SessionStore
import com.dashboard.core.SettingsStore

/**
 * Global application container. Holds the [ConnectionManager],
 * [GoogleAccountSync], [SettingsStore] and [SessionStore] shared by all screens.
 *
...
class DashboardApp : Application() {
    ...
    val connection: ConnectionManager by lazy { ConnectionManager(this, google, sessions) }
