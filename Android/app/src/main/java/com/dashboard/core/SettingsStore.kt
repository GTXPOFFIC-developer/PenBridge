...
class SettingsStore(context: Context) {
    ...
    private fun load(): AppSettings {
        ...
        return AppSettings(
            ...
            inputMode = if (prefs.getString(KEY_INPUT_MODE, "TRACKPAD") == "TABLET") InputMode.TABLET else InputMode.TRACKPAD,
            trackpadSensitivity = prefs.getFloat(KEY_SENSITIVITY, 1.3f),
            fingerInput = prefs.getBoolean(KEY_FINGER, false),
